...
export const sentimentDisplay: SentimentDisplay = {
  ...
  Negative: {
    icon: <Angry className="size-8 text-red-500" />,
    color: 'text-red-500',
    description: 'The sentiment of the text is generally negative.',
  },
  Mixed: {
    icon: <Annoyed className="size-8 text-yellow-500" />,
    color: 'text-yellow-500',
    description: 'The sentiment of the text is mixed.',
  },
  Neutral: {
    icon: <Meh className="size-8 text-blue-500" />,
    color: 'text-blue-500',
    description: 'The sentiment of the text is neutral.',
  },
};

export const sentimentServices: {[key: string]: string} = {
  AWS: 'Amazon Comprehend',
  AZURE: 'Azure AI Language Service'
}